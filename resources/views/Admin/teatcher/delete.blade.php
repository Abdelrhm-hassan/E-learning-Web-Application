...
<div class="d-flex justify-content-between ">
    ...
    <h3 class="tm-site-title" > teatchers / Delete / {{$data->name}} </h3>
  ...
  <div class="row">
    <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
      <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
        <div class="row">
          <div class="col-12">
            <h2 class="tm-block-title d-inline-block">Delete Teatcher</h2>
          </div>
        </div>
        <div class="row tm-edit-product-row">
      
          <div class="col-xl-6 col-lg-6 col-md-12">
            <form action="{{route('Admin.teatcher.dodelete')}}" enctype="multipart/form-data"method="post" class="tm-edit-product-form">
             @csrf
          ...
          <div class="col-12">
            <button type="submit" class="btn btn-danger btn-block text-uppercase">Delete Teatcher Now</button>
          </div>
        </form>
        </div>
      </div>
