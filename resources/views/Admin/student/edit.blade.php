...
<div class="d-flex justify-content-between ">
    ...
    <h3 class="tm-site-title" > Student / Edit / {{$data->name}} </h3>
  ...
  <div class="row">
    <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
      <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
        <div class="row">
          <div class="col-12">
            <h2 class="tm-block-title d-inline-block">Edit Student</h2>
          </div>
        </div>
        <div class="row tm-edit-product-row">
      
          <div class="col-xl-6 col-lg-6 col-md-12">
            <form action="{{route('Admin.student.update')}}" enctype="multipart/form-data"method="post" class="tm-edit-product-form">
             @csrf
          ...
          <div class="col-12">
            <button type="submit" class="btn btn-primary btn-block text-uppercase">Add Student Now</button>
          </div>
        </form>
        </div>
      </div>
